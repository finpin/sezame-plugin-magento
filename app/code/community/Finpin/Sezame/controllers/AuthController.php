...
class Finpin_Sezame_AuthController extends Mage_Core_Controller_Front_Action
{
    ...
    public function loginAction ()
    {
        ...
        {
            case 'initiated':
                Mage::getSingleton('core/session')->addError($helper->__('The request has not been authorized in time.'));
                break;
    ...
    public function statusAction()
    {
        ...
        switch ($ret->status)
        {
            ...
            case 'denied':
                Mage::getSingleton('core/session')->addError($helper->__('The authorization has been denied.'));
                break;
